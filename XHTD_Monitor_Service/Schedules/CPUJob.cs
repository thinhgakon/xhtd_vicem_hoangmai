...
namespace XHTD_Monitor_Service.Schedules
{
    public class CPUJob : IJob
    {
      ...
      (System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        ...
        public CPUJob(IServiceFactory serviceFactory)
        {
        ...
        public void MonitorCPUAndRAM()
        {
            try
            {
                ...
                if (cpu > 70 || percentOccupied > 70)
                {
                    _serviceFactory.Notification.SendNotificationToTelegram($@"============ c {cpu} r {percentOccupied}===========");
                    //string contentStart = $@"<h1>Thông báo của hệ thống monitor server</h1>
                    //        Dear anh,
                    //        <br />
                    //        RAM {percentOccupied} % 
                    //        <br />
                    //        CPU {cpu} % ";
                    //_serviceFactory.Common.SendMail("Server HM", "trungnc.bk@gmail.com", "HM SERVER", "Thông tin từ hệ thống server 72", contentStart, "");
                }
            }
            catch (Exception ex)
            {
