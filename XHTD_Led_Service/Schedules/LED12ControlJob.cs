...
{
    public class LED12ControlJob : IJob
    {
      ...
      (System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        ...
        public LED12ControlJob(IServiceFactory serviceFactory)
        {
        ...
        public void ShowLed12Process()
        {
            ...
            var orderShows = _serviceFactory.StoreOrderOperating.GetStoreOrderForLED12();
            //try
            //{
            //    new MyHub().Send("xhtd_web", JsonConvert.SerializeObject(orderShows));
            ...
            {
                var vehicleNewList = String.Join(",", orderShows.Select(x => $"{x.Vehicle}_{x.IndexOrder}").ToList());
                if (vehicleNewList == Program.Led12Point) return;
                Program.Led12Point = vehicleNewList;
            }
