...
namespace XHTD_Getway_In_Service.LEDControl
{
    public class LEDGetwayFrontControl
    {
      ...
      (System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        ...
        public LEDGetwayFrontControl(IServiceFactory serviceFactory)
        {
            _serviceFactory = serviceFactory;

            m_nSendType_LEDFront = 0;
            string strParams_LEDFront = "192.168.22.17";
            m_pSendParams_LEDFront = Marshal.StringToHGlobalUni(strParams_LEDFront);
        }
        public void SendLedFrontAllArea(bool isShowArea1, bool isShowArea2, bool isShowArea3, bool isInviteVehicleComeIn, string contentComeIn)
        {
            // SendLedArea1(); // 96x64
            //128x64
            //SendLedArea3();
            ...
            try
            {
                ...
                if (isShowArea1)
                {
                    if (isInviteVehicleComeIn)
                    {
                        ...
                        IntPtr pText = Marshal.StringToHGlobalUni(($"  Mời xe\n  {contentComeIn.ToUpper()} \nvào cổng").ToUpper());
                        ...
                        int nAreaItemID_1 = CSDKExport.Hd_AddSimpleTextAreaItem(nAreaID: nAreaID_1, pText: pText, nTextColor: nTextColor, nBackGroupColor: 0, nStyle: nTextStyle,
                ...
                if (isShowArea2)
                {
                    ...
                    IntPtr pText_Main = Marshal.StringToHGlobalUni("CHỜ LOA GỌI");
                    ...
                    pText_Main = Marshal.StringToHGlobalUni("YÊU CẦU - ĐI CHẬM\nCHỜ BARRIER MỞ".ToUpper());
                    nEffect_Main = 0;
